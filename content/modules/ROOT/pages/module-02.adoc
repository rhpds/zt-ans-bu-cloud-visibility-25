...
. **Configure the `Extra Variables` section.**
+
...
+
To view the data, click on the **Print vpc info to terminal** task. In the details pane that appears, first select the **Data** tab, then the **JSON** tab to see the structured data retrieved from AWS. We have pre-configured one VPC in this region.
+
